# Name: Adeolu Abiodun  ||  Date: 09/17/2024  ||  Program file: adeoluAbiodun_lab6-3.py
...
def main():
    file_path = input("Enter the full path of the file to read (e.g., C:\\Users\\YourName\\Downloads\\exceptionNumbers.txt): ")
